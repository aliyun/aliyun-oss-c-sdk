    ...
    const oss_select_object_params_t *params)
{
    ...
    // InputSerialization
    int32_t has_compression = !aos_string_is_empty(&params->input_param.compression_type);
    int32_t has_csv = !aos_string_is_empty(&params->input_param.file_header_info) ||
...
static char *oss_build_create_select_object_meta_xml(aos_pool_t *p, const oss_select_object_meta_params_t *params)
{
    ...
    int32_t has_csv = !aos_string_is_empty(&params->record_delimiter) ||
